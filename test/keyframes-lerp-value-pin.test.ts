 ...
 * «value = from» (интерполяция схлопнута в стартовую точку сегмента) ВЫЖИВАЕТ
 ...
 *
 * RED-proof (диверсия): в src/internal/sample-keyframes.ts заменить
 *   `const value = from + (to - from) * eased;` → `const value = from;`
