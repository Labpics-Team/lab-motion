 ...
 * прогресс-пространствами по ДОМИНАНТНОМУ компоненту старого спана
 * (канон WaapiUnit.dominantV0): v0' = normalizeV0(ṗ̂·Δold_i, Δnew_i),
 * i = argmax|Δold|. Для юнитных значений (1 компонент) и коллинеарных
