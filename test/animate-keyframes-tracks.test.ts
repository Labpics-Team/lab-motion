 ...
 *   V. Валидация times/ease[] (LM173/LM174/LM138), трек+пружина → LM136,
...
describe('#205/V контракт times/ease[]/режима', () => {
  ...
  it('матрица некорректных times → LM173', () => {
    for (const times of [
      ...
      throwsCode('LM173', () => animate(el(), { opacity: [0, 1, 0.5] }, {
        duration: 100,
  ...
  it('несовпадение топологии с times → LM173 (пары/дестинации включительно)', () => {
    throwsCode('LM173', () => animate(el(), { opacity: [0, 1] }, {
      duration: 100,
      times: [0, 0.5, 1],
    }));
    throwsCode('LM173', () => animate(el(), { opacity: 1 }, {
      duration: 100,
      times: [0, 1],
    }));
    throwsCode('LM173', () => animate(el(), { x: [0, 10, 0], opacity: [0, 1] }, {
      duration: 100,
      times: [0, 0.5, 1],
    }));
  });

  it('ease[]: пустой → LM174; не-функция → LM138; длина ≠ N−1 → LM174', () => {
    throwsCode('LM174', () => animate(el(), { opacity: [0, 1, 0.5] }, {
      duration: 100,
      ease: [] as never,
    }));
