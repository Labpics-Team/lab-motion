...
//   • 356:* / 359 / 360 (finite-safety-net): ветка clampedValue недостижима (clamp к
//     конечным [from,target] всегда конечен); ветка rawVelocity срабатывает лишь при
//     overflow, но эмитится всё равно clamped-конечное значение (_velocity наружу не
//     виден) → эффект нетто замаскирован. Замер: range=1e308 → все эмиссии finite.
