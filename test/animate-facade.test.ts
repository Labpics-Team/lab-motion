 ...
 *
 * ── RED PROOF ────────────────────────────────────────────────────────────────
 * Файл рождён на пустой заглушке src/animate/index.ts (export {}) — каждый тест
 * падает («animate is not a function» / ассерты поверхности). GREEN — только
 * с реализацией фасада. Мутанты, которые ловит файл (Класс Д, вручную):
