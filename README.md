...
Корневой экспорт + 42 субпути (входов `exports` в `package.json` — 43):
...
| Доменные эффекты | `./bindings`, `./flip`, `./projection`, `./smart`, `./gestures`, `./behaviors`, `./scroll`, `./in-view`, `./presence`, `./svg`, `./svg-morph`, `./a11y`, `./surface` (приватный executor compiled-поверхности) |
