...
1. **Всё — субпути.** Корневой экспорт + 36 субпутей (37 входов `exports` в
...
регрессионными потолками. Методология, источник сравнительного runtime-отчёта и
границы допустимых выводов описаны в [docs/бенчмарк.md](docs/бенчмарк.md).
...
рядом с измерителем в `scripts/size-gate.mjs`.
