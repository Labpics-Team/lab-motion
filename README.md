...
**Свежие метрики 2026-07-09 (worktree `lab-motion-perf` на `docs/size-perf-table-step5`, `node scripts/size-gate.mjs`, `bench.mjs`, `bench-latency.mjs`, `vitest -t perf-hot-path` — все PASS; re-grounded post-edit):**
