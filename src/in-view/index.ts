...
// Ловля через границу субпутей: у ./in-view СВОЯ копия класса (см. ниже),
// поэтому `instanceof` с классом из корня здесь ложен — как и в любом
// другом субпути. Гвард сравнивает бренд `name` и потому работает на
// ошибке из любой копии; он tree-shakeable и ничего не стоит, если не нужен.
