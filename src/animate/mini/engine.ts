/**
 * animate/mini/engine.ts — движок анимации за швом кодеков/адаптеров.
 *
 * НЕ ВЕТВИТСЯ по имени свойства: канал резолвит codec через CodecResolver,
 * запись — через adapter._surfaceOf/_compose/_apply. Новый вид свойства/цели =
 * новая реализация кодека/адаптера за швом, не правка этого файла
 * (ЗАКОН расширения, registry.ts).
 *
