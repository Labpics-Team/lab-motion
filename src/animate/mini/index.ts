 ...
 *
 * mini связывает минимальный внутренний набор кодеков/адаптеров фиксированным
 * O(1)-resolver (без runtime-реестра) и не тянет ./value или
 * compositor-компилятор. Публичного registry API у субпути нет.
