 ...
 *   1. Zero runtime deps на импорте примитивов (easing тянет ../easing лишь при
 *      обращении к семейству `easing`; `duration`/`spring`/`staggerGap` — чистые
 *      данные без импортов) — tree-shakeable по семействам.
