...
| Группа | Субпути |
| --- | --- |
| Ядро анимации | `./nano` (platform-trusted WAAPI, ≤1 KB), `./lite` (WAAPI-first эргономичный, <5 KB), `./animate` (основной продуктовый вход), `./frame`, `./driver`, `./compositor`, `./compositor/stagger`, `./waapi`, `./auto` |
